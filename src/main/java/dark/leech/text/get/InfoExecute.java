...
import dark.leech.text.plugin.js.loader.DetailLoader;
...
public class InfoExecute extends SwingWorker {
    ...
    public InfoExecute plugin(PluginEntity pluginEntity) {
        detailLoader = DetailLoader.with(pluginEntity);
        return this;
    }
    ...
    protected Void doInBackground() {
        try {
            BookEntity book = detailLoader.load(properties.getUrl());
            ...
            Log.add("InfoExecute error: " + e.getMessage());
        }
        return null;
    }
