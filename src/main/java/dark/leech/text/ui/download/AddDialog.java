...
public class AddDialog extends JMDialog {
    ...
    protected void onCreate() {
        ...
        btOk.setText("OK");
        btOk.addActionListener(e -> actionAdd());
        container.add(btOk);
        ...
        btShowChap.addActionListener(e -> actionShow());
    ...
    private void actionAdd() {
        if (doImp) {
            ...
            if (properties.getName().isEmpty()) {
                tfName.addError("Tên truyện không được để trống!");
                return;
            }
            if (properties.getAuthor().isEmpty()) {
    ...
    private void actionShow() {
        ...
        list.setChangeListener(() -> tfChap.setText(list.getParseList()));
        list.open();
    }
