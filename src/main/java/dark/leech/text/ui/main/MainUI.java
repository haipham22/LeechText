...
import dark.leech.text.ui.main.plugin.VBookPluginBrowserUI;
...
public class MainUI extends JFrame implements BlurListener, ActionListener {
    ...
    private JMMenuItem pnVBookPlugins;
    ...
    private void createPopupMenu() {
        ActionListener actionListener =
                e -> {
                    ...
                    if (e.getSource() == pnVBookPlugins) new VBookPluginBrowserUI().open();
        ...
        pnVBookPlugins = new JMMenuItem("Add plugin");
        pnVBookPlugins.addActionListener(actionListener);
        menu.add(pnVBookPlugins);
