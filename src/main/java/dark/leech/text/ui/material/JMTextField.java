...
public class JMTextField extends JTextField {
    ...
    public void addError(String err) {
        ...
        BalloonTipStyle style =
                new MinimalBalloonStyle(
                        new Color(color.getRed(), color.getGreen(), color.getBlue(), 200), 5);
        final BalloonTip balloonTip =
                new BalloonTip(
                        this,
