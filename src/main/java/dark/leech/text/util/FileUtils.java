...
public class FileUtils {
    ...
    /**
     * Download image from URL and convert to JPEG if it's WebP format. Use this for cover images to
     * ensure EPUB compatibility.
     */
    public static void url2fileConvertWebP(String url, String savePath) {
        ImageConverter.downloadAndConvertToJpeg(url, savePath);
    }
