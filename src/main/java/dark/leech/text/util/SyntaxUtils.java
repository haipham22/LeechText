...
public class SyntaxUtils {
    private static final String[] dau =
            new String[] {
                "̀â", "ấ", "ậ", "ẩ", "ẫ", "à", "á", "ạ", "ả", "ã", "â", "ằ", "ắ", "ặ",
                "ẳ", "ẵ", "ă", "ề", "ế", "ệ", "ể", "ễ", "è", "é", "ẹ", "ẻ", "ẽ", "ê",
                "ì", "í", "ị", "ỉ", "ĩ", "ồ", "ố", "ộ", "ổ", "ỗ", "ò", "ó", "ọ", "ỏ",
                "õ", "ô", "ờ", "ớ", "ợ", "ở", "ỡ", "ơ", "ù", "ú", "ụ", "ủ", "ũ", "ừ",
                "ứ", "ự", "ử", "ữ", "ư", "ỳ", "ý", "ỵ", "ỷ", "ỹ", "đ", "Ầ", "Ấ", "Ậ",
                "Ẩ", "Ẫ", "À", "Á", "Ạ", "Ả", "Ã", "Â", "Ằ", "Ắ", "Ặ", "Ẳ", "Ẵ", "Ă",
                "Ề", "Ế", "Ệ", "Ể", "Ễ", "È", "É", "Ẹ", "Ẻ", "Ẽ", "Ê", "Ì", "Í", "Ị",
                "Ỉ", "Ĩ", "Ồ", "Ố", "Ộ", "Ổ", "Ỗ", "Ò", "Ó", "Ọ", "Ỏ", "Õ", "Ô", "Ờ",
                "Ớ", "Ợ", "Ở", "Ỡ", "Ơ", "Ù", "Ú", "Ụ", "Ủ", "Ũ", "Ừ", "Ứ", "Ự", "Ử",
                "Ữ", "Ư", "Ỳ", "Ý", "Ỵ", "Ỷ", "Ỹ", "Đ"
            };
    private static final String[] src =
            new String[] {
                "ầ", "ấ", "ậ", "ẩ", "ẫ", "à", "á", "ạ", "ả", "ã", "â", "ằ", "ắ", "ặ", "ẳ", "ẵ", "ă",
                "ề", "ế", "ệ", "ể", "ễ", "è", "é", "ẹ", "ẻ", "ẽ", "ê", "ì", "í", "ị", "ỉ", "ĩ", "ồ",
                "ố", "ộ", "ổ", "ỗ", "ò", "ó", "ọ", "ỏ", "õ", "ô", "ờ", "ớ", "ợ", "ở", "ỡ", "ơ", "ù",
                "ú", "ụ", "ủ", "ũ", "ừ", "ứ", "ự", "ử", "ữ", "ư", "ỳ", "ý", "ỵ", "ỷ", "ỹ", "đ", "Ầ",
                "Ấ", "Ậ", "Ẩ", "Ẫ", "À", "Á", "Ạ", "Ả", "Ã", "Â", "Ằ", "Ắ", "Ặ", "Ẳ", "Ẵ", "Ă", "Ề",
                "Ế", "Ệ", "Ể", "Ễ", "È", "É", "Ẹ", "Ẻ", "Ẽ", "Ê", "Ì", "Í", "Ị", "Ỉ", "Ĩ", "Ồ", "Ố",
                "Ộ", "Ổ", "Ỗ", "Ò", "Ó", "Ọ", "Ỏ", "Õ", "Ô", "Ờ", "Ớ", "Ợ", "Ở", "Ỡ", "Ơ", "Ù", "Ú",
                "Ụ", "Ủ", "Ũ", "Ừ", "Ứ", "Ự", "Ử", "Ữ", "Ư", "Ỳ", "Ý", "Ỵ", "Ỷ", "Ỹ", "Đ"
            };
    ...
    public static String xoaDau(String source) {
        ...
        for (int i = 0; i < src.length; i++) source = source.replace(src[i], xoa[i]);
        return source;
    }
