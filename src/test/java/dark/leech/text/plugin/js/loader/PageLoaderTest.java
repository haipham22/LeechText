...
/**
 * Unit and integration tests for PageLoader.
 * Tests the page discovery pattern for vBook plugins.
 */
public class PageLoaderTest {
    ...
    public void testBasicPageDiscovery() {
        ...
        assertEquals("First URL should match", "https://truyenfull.vision/ajax.php?type=list_chapter&page=1", urls.get(0));
    }
    ...
    public void testTruyenFullPagePattern() {
        ...
        PluginEntity plugin = PluginEntity.builder()
                ...
                .pageGetter(
                    "function execute(url) {" +
                    "  var totalPages = 3;" +
                    "  var truyenId = 'test-novel';" +
                    "  var list = [];" +
                    "  for (var i = 1; i <= totalPages; i++) {" +
                    "    list.push('https://truyenfull.vision/ajax.php?type=list_chapter&tid=' + truyenId + '&page=' + i);" +
                    "  }" +
    ...
    public void testObjectWithUrlProperty() {
        ...
        PluginEntity plugin = PluginEntity.builder()
                ...
                .pageGetter(
                    "function execute(url) {" +
                    "  return Response.success({url: 'https://test.com/page-1'});" +
                    "}"
                )
                .build();
    ...
    public void testObjectWithLinkProperty() {
        ...
        PluginEntity plugin = PluginEntity.builder()
                ...
                .pageGetter(
                    "function execute(url) {" +
                    "  return Response.success({link: 'https://test.com/page-1'});" +
                    "}"
                )
                .build();
